...
namespace Trendimaa.DAL.Relations
{
    public class ApplyRelations
    {
        public static void ApplyRelation(ModelBuilder builder)
        {
            ...
            builder.Entity<QuestionAnswer>().HasOne(i=>i.AppUser).WithMany(i=>i.QuestionAnswers).HasForeignKey(i=>i.AppUserId).IsRequired(false).OnDelete(DeleteBehavior.SetNull);
            builder.Entity<QuestionAnswer>().HasOne(i=>i.Seller).WithMany(i=>i.QuestionAnswers).HasForeignKey(i=>i.SellerId).IsRequired(false).OnDelete(DeleteBehavior.SetNull);
            builder.Entity<QuestionAnswer>().HasOne(i=>i.Product).WithMany(i=>i.QuestionAnswers).HasForeignKey(i=>i.ProductId).IsRequired(false).OnDelete(DeleteBehavior.SetNull);
            ...
            builder.Entity<Seller>().HasOne(a => a.Image).WithOne(s => s.Seller).HasForeignKey<Seller>(s => s.ImageId).IsRequired(false).OnDelete(DeleteBehavior.SetNull);
