...
namespace Trendimaa.API.Controllers
{
    ...
    [ApiController]
    public class SearchRelatedController : ControllerBase
    {
        public readonly ISearchRelatedService _service;

        public SearchRelatedController(ISearchRelatedService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> CreateAsy(SearchRelated entity)
        {
        ...
        [HttpPut]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> UpdateAsy(SearchRelated entity)
        {
