...
namespace Trendimaa.API.Controllers
{
    ...
    {
        public readonly IAddressService _service;
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> CreateAsy(Address entity)
        {
        ...
        [HttpPut]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> UpdateAsy(Address entity)
        {
