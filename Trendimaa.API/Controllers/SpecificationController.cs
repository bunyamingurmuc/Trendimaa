...
namespace Trendimaa.API.Controllers
{
    ...
    {
        public readonly ISpecificationService _service;
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> CreateAsy(Specification entity)
        {
        ...
        [HttpPut]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> UpdateAsy(Specification entity)
        {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> CreateRangeAsync(List<Specification> list)
        {
        ...
        [HttpGet]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> GetProductSpecifications(int productId)
        {
