...
namespace Trendimaa.API.Controllers
{
    ...
    {
        public readonly IFavoriteService _service;
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> CreateAsy(Favorite entity)
        {
        ...
        [HttpPut]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> UpdateAsy(Favorite entity)
        {
