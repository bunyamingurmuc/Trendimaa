...
namespace Trendimaa.API.Controllers
{
    ...
    {
        public readonly IUserKeyService _service;

        public UserKeyController(IUserKeyService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> CreateAsy(UserKey entity)
        {
        ...
        [HttpPut]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> UpdateAsy(UserKey entity)
        {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> CreateRangeAsync(List<UserKey> list)
        {
