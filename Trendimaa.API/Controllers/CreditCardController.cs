...
namespace Trendimaa.API.Controllers
{
    ...
    {
        public readonly ICreditCardService _service;
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> CreateAsy(CreditCard entity)
        {
        ...
        [HttpPut]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> UpdateAsy(CreditCard entity)
        {
        ...
        [HttpGet]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> GetUserCCs(int id)
        {

            var response = await _service.GetUserCCs(id);
            return this.ResponseStatusWithData(response);
        }
    }
}
