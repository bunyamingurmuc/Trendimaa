...
namespace Trendimaa.API.Controllers
{
    ...
    public class CommentController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> CreateAsy(Comment entity)
        {
        ...
        [HttpPut]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> UpdateAsy(Comment entity)
        {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> CreateRangeAsync(List<Comment> comments)
        {
